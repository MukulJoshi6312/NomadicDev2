...
import {assets, blogCategories} from "../../assest/assets"
  ...
  return (
    ...
    className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
       ...
       name="category" className='mt-2 px-3 py-2 border text-gary-500 border-gray-300 outline-none rounded'>
        ...
        <button disabled={isAdding} type='submit' className='mt-8 w-40 h-10 bg-primary text-white roudned cursor-pointer text-sm'>{ isAdding ? 'Adding...' : 'Add Blog'}</button>
